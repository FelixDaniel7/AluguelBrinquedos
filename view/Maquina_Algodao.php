...
<head>
  ...
  <title>Máquina de Algodão Doce - Aluguel Briquedos</title>
    ...
    <div class="container">
      ...
      <div class="row">
          ...
          <div class="card-deck">
                  ...
                  <ol class="carousel-indicators">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="img/produtos/MaquinaAlgodão/1.jpg" alt="Primeiro Slide">
                      </div>
              ...
              <div class="card">
                  <h5 class="card-header">Máquina de Algodão Doce</h5>
                  <div class="card-body">
                    <h5 class="card-title">R$ 40,00
                      <br>
                        <a id="retorno">
      ...
      <div class="row">     
          <div class="card-deck " >
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Piscina de bolonhas</h5>
