<?php
session_start();
include_once("../bddedados/conexao.php");
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Disponibilidade</li>
			</ol>
		</div><!--/.row-->
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="visualizar">
							...
							<form class="form-horizontal" method="POST" action="proc_delet_evento.php">
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
										<button type="button" class="btn btn-canc-vis btn-warning">Editar</button>
										<input type="hidden" class="form-control" name="id" id="id">
										<?php
											echo" <a href='' onclick='return Confirmar()'> <button type='submit' class='btn btn-danger'>Excluir</button> </a> ";
										?>
									</div>
								</div>							
							</form>
		...
		<div class="modal fade" id="cadastrar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal" method="POST" action="../controller/proc_cad_evento.php">
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">Titulo</label>
								<div class="col-sm-10">
		...
		<script type="text/javascript">
			function Confirmar(){
				return confirm('Este evento ira ser excluido!')
			}
		</script>
		<script>
